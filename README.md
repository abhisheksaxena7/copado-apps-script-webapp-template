...
The repository owner confirmed provenance, Copado branding/republication approval, personal-account publication, and MIT compatibility. The public template is released as `v0.1.2`; promotion to `v1.0.0` still requires the live Google Apps Script canary.
